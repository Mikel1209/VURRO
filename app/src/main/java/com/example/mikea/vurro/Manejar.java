...
public class Manejar extends AppCompatActivity {
    ImageButton imgbinfo,btniArriba,btniDerecha,btniAbajo, btniIzquierda;
    ...
    private Manejar.ConnectedThread MyConexionBT;
    ...
    public void onResume()
    {
        ...
        MyConexionBT = new Manejar.ConnectedThread(btSocket);
        MyConexionBT.start();
    }
